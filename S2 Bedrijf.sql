...
-- eerst moet ik weten wat het docentnummer is van Nick Smit.

select mnr
from medewerkers
where naam = 'SMIT';

-- 7369 is het nummer van Nick Smit.

INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie)
VALUES ('S02', '2026-03-02', 7369, 'LEERDAM');
...
VALUES (8888, 'BALCI', 'F', 'STAGIAIR', 7839, '2001-06-15', 1000.00, 200.00, 10, 'V');
...
-- Voeg deze cursus met code 'D&P' toe, 
-- maak twee uitvoeringen in Leerdam en schrijf drie
-- mensen in.                                                                                      -- [TEST]


-- Eerst maak ik de cursus aan
INSERT INTO cursussen (code, omschrijving, type, lengte)
VALUES ('D&P', 'Data & Persistency', 'ALG', 6);


-- Ik voeg twee uitvoeringen toe met verschillende datums
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie)
VALUES ('D&P', '2026-03-03', 7902, 'LEERDAM'),
('D&P', '2026-03-04', 7902, 'LEERDAM');

-- Ik schrijf drie mensen in via inschrijvingen

INSERT INTO inschrijvingen (cursist, cursus, begindatum, evaluatie)
VALUES (7499, 'D&P', '2026-03-03', 2),
(7934, 'D&P', '2026-03-03', 2),
(7788, 'D&P', '2026-03-04', 2);
...
-- Ik kijk welke medewerkers behoren tot afdeling verkoop
select * from afdelingen;
-- Ik zie dat anr = 30 en hoofd = 7698 bij afdeling VERKOOP

-- Ik kijk welke medewerkers chef = 7698 hebben
select * 
from medewerkers
where chef = 7698;

-- Ik verhoog voer een rekensom uit op deze geselecteerde groep waardoor het salaris 5.5% omhoog gaat.

UPDATE medewerkers
SET maandsal = maandsal * 1.055
WHERE chef = 7698;

-- Ik verhoog de manager 7698 via mnr met 7%
UPDATE medewerkers
...
-- ANTWOORD: De code geeft een error, want ik probeer deze medewerker te verwijderen uit een tabel waar nog naar verwezen wordt met een foreign key uit de tabel inschrijvingen. 
-- Als je deze medewerker zou verwijderen dan zou je een inschrijving hebben zonder bestaande medewerker en dat kan niet.
...
-- Ik kijk naar de tabel medewerkers om te weten wat het nummer is van de koning
select mnr 
from medewerkers
where naam = 'DE KONING';

-- Dit medewerkernummer is 7839

-- Hierna maak ik de nieuwe afdeling aan.
INSERT INTO afdelingen (anr, naam, locatie, hoofd)
VALUES (60, 'FINANCIEN', 'LEERDAM', 8889);

--Hierna maak ik mijzelf aan in de medewerkertabel
INSERT INTO medewerkers (mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm, afd, geslacht)
VALUES (8889, 'BALCI', 'F', 'HOOFD', 7839, '2001-06-15', 5000.00, 200.00, 60, 'V');
                                                                                      -- [TEST]
